    ...
    @endphp
                ...
                <div class="header-right ml-4">
                    <div class="header-call d-xs-show d-lg-flex align-items-center">
                        ...
                        <div class="call-info d-lg-show">
                            ...
                            <a href="tel:#"  class="phone-number font-weight-bolder ls-50">+8801738153971</a>
                        </div>
                    </div>
        ...
        <div class="header-bottom sticky-content fix-top sticky-header has-dropdown " style="border: 1px solid rgba(240, 237, 237, 0.856)">
            <div class="container">
                <div class="inner-wrap">
                    <div class="header-left ">
                        <div class="dropdown category-dropdown has-border">
                            <a href="#"  class="category-toggle said rita"
                                title="Browse Categories">
                                <i class="w-icon-category"></i>
                                <span id="sharifcat">Browse Categories</span>
                            </a>

                            <div class="dropdown-box sharif">
