                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title">Post Tag</h4>
                            <a href="" class="font-weight-bold btn btn-danger">Trash Post Tag <i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($tags as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('post-tag.edit', $item -> id)}}" class="btn btn-sm btn-warning"><i class="fa fa-edit" ></i></a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('post-tag.update', $edit -> id)}}" method="POST">
                                ...
                                <div class="text-right">
                                    <a class="btn btn-warning" href="{{route('post-tag.index')}}">Back</a>
